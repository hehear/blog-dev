...
<head>
  ...
  <title>Running coder management system</title>
  <link rel="shortcut icon" href="/images/favicon.png" type="image/png">
  <!-- css -->
  <#include "/common/commoncss.ftl" encoding="UTF-8"> 
</head>
<body>
<!-- Preloader -->
<div id="preloader">
...
<section>
  <!-- 左侧菜单 strt -->
  <#include "/common/left.ftl" encoding="UTF-8"> 
  <!-- 左侧菜单 end -->
...
<div style="text-align:center;">
  ...
  <!-- js -->
  <#include "/common/commonjs.ftl" encoding="UTF-8"> 
</html>
